# 2025-01-25T19:08:23.188835
import vitis

client = vitis.create_client()
client.set_workspace(path="vitis_workspace")

platform = client.create_platform_component(name = "platform_with_timer",hw_design = "$COMPONENT_LOCATION/../../microblazev_wrapper.xsa",os = "standalone",cpu = "microblaze_riscv_0",domain_name = "standalone_microblaze_riscv_0")

platform = client.get_component(name="platform_with_timer")
...
client.delete_component(name="platform_with_timer")
