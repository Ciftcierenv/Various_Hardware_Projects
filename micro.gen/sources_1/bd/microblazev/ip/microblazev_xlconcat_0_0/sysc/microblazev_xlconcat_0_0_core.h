...
#ifndef _microblazev_xlconcat_0_0_core_h_
#define _microblazev_xlconcat_0_0_core_h_
...
class microblazev_xlconcat_0_0_core : public sc_module 
{
    public: 
       microblazev_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(microblazev_xlconcat_0_0_core);
    ...
    virtual ~microblazev_xlconcat_0_0_core() = default;
