...
`timescale 1 ns / 1 ps
	...
	(
		...
		output wire  timer_interr, //debug icin
		output wire  ack,
...
// Instantiation of Axi Bus Interface S00_AXI
	mytimer_slave_lite_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) mytimer_slave_lite_v1_0_S00_AXI_inst (
	    .prescaler(prescaler),
...
// Instantiation of Axi Bus Interface S_AXI_INTR
	mytimer_slave_lite_inter_v1_0_S_AXI_INTR # ( 
	...
	) mytimer_slave_lite_inter_v1_0_S_AXI_INTR_inst (
	    .timer_interrupt(timer_interr),
