...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_20 -L smartconnect_v1_0 -L xilinx_vip"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/eciftci/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblazev.wdb xsim.dir libdpi.so)
